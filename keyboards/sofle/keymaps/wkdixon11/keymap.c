...
[_QWERTY] = LAYOUT(
  ...
  KC_LSPO,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     KC_RGUI,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSPC,
                 OSM(MOD_LCTL),OSM(MOD_LGUI),OSM(MOD_LALT), MO(2), KC_BSPC,      KC_SPC,  MO(3),  OSM(MOD_RALT), OSM(MOD_RGUI), OSM(MOD_RCTL)
),
/*
 * COLEMAK
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_COLEMAK] = LAYOUT(
  ...
  KC_LSPO,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_MUTE,      KC_RGUI,KC_K,    KC_H, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSPC,
                 OSM(MOD_LCTL),OSM(MOD_LGUI),OSM(MOD_LALT), MO(2), KC_BSPC,      KC_SPC,  MO(3),  OSM(MOD_RALT), OSM(MOD_RGUI), OSM(MOD_RCTL)
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_RAISE] = LAYOUT(
  ...
  KC_TRNS,LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), LCTL(KC_B),  KC_TRNS,       KC_TRNS,  KC_NO, C(A(LCA(KC_DEL))), KC_NO, KC_NO,   KC_NO, KC_NO,
