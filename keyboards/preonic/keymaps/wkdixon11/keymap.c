...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  KC_CAPS,    KC_EXLM,  KC_AT,    KC_HASH,  KC_DLR,   KC_PERC,  KC_CIRC,  KC_AMPR,  KC_ASTR,  KC_LPRN,  KC_RPRN,  KC_UNDS,
  KC_TRNS,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_TILD,  KC_GRV,   KC_TRNS,
  KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_ENT,   KC_ENT,   KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS
),
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  KC_CAPS,  KC_LBRC,  KC_RBRC,  KC_BSLS,      KC_HOME,  KC_PGUP,  KC_NO,    KC_PSCR,  KC_INS,     KC_SLCK,  KC_PAUS,  KC_F12,
  KC_LSFT,  KC_LCBR,  KC_RCBR,  KC_PIPE,      KC_END,   KC_PGDN,  KC_NO,    KC_NO,    KC_NO,      KC_NO,    KC_NO,    KC_TRNS,
  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,      KC_TRNS,  KC_DEL,   KC_DEL,   KC_TRNS,  KC_MNXT,    KC_MUTE,  KC_MPLY,  KC_NO
),
/* Adjust (Lower + Raise)
 * ,-----------------------------------------------------------------------------------.
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  KC_TRNS,  KC_TRNS,   MU_MOD,   AU_ON,   AU_OFF,     AG_NORM,    AG_SWAP, QWERTY,   COLEMAK,    QWERTY2,    KC_TRNS,    KC_TRNS,
